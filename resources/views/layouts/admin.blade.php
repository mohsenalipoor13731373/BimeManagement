...
<head>
    ...
    <title>مدیریت دفترچه درمانی</title>
        ...
        <div class="col-md-3 left_col hidden-print">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>بیمه</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i>بیمه
                                    <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('admin.module.bime.wizard')}}">افزودن</a></li>
                                    <li><a href="{{route('admin.module.bime.maketable')}}">مشاهده</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-edit"></i>بیمه شدگان
                                    <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('admin.module.usersbime.wizard')}}">افزودن</a></li>
                                    <li><a href="{{route('admin.module.usersbime.maketable')}}">مشاهده</a></li>
                                </ul>
                            </li>
